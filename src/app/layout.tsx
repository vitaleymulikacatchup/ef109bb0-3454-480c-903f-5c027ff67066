...
export const metadata: Metadata = {
  title: "SneakerVault - Premium Sneakers & Limited Drops",
  description: "Discover the hottest sneakers from Nike, Adidas, Jordan and more. Authentic sneakers, limited releases, and exclusive member benefits at SneakerVault.",
  keywords: "sneakers, Nike, Adidas, Jordan, limited edition, authentic sneakers, sneaker store",
  metadataBase: new URL("https://sneakervault.com"),
  alternates: {
    canonical: "https://sneakervault.com"
  },
  openGraph: {
    title: "SneakerVault - Premium Sneakers & Limited Drops",
    description: "Discover the hottest sneakers from Nike, Adidas, Jordan and more. Authentic sneakers, limited releases, and exclusive member benefits.",
    siteName: "SneakerVault",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/4027606/pexels-photo-4027606.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "SneakerVault - Premium Sneakers & Limited Drops",
    description: "Discover the hottest sneakers from Nike, Adidas, Jordan and more.",
    images: ["https://images.pexels.com/photos/4027606/pexels-photo-4027606.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
